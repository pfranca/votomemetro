...
export const questions = [
  {
    ...
    answers: [
      ...
      { id: "a6", text: "Mais ministérios? Para quê?", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a8", text: "Desde que os custos estejam bem calculados, não me oponho.", value: "PSD" },
    ],
  },
  {
    id: 3,
    text: "O preço da bica sobe para 1,40€. Reação?",
    answers: [
      { id: "a1", text: "Criminalizem o aumento. É especulação capitalista!", value: "PCP" },
      { id: "a2", text: "Bica a 1,40€? Isto é Lisboa a matar o povo.", value: "BE" },
      { id: "a3", text: "Paguem, se querem bom café biológico.", value: "PAN" },
      { id: "a4", text: "Querem destruir os velhos cafés para meter Starbucks!", value: "Chega" },
      { id: "a5", text: "Vamos criar um fundo de apoio a pastelarias independentes.", value: "PS" },
      { id: "a6", text: "Liberalizem o mercado da bica, já.", value: "IL" },
      { id: "a7", text: "Investiguem se o aumento viola alguma cláusula europeia.", value: "PSD" },
      { id: "a8", text: "Desde que haja opção sem cafeína e colonialismo, tudo bem.", value: "Livre" },
    ],
  },
  {
    id: 4,
    ...
    answers: [
      ...
      { id: "a2", text: "Desde que o júri não seja nomeado pelo PS, até pode ser.", value: "PSD" },
  ...
  {
    id: 5,
    text: "O Primeiro-Ministro foi visto de trotinete elétrica, sem capacete, a comer uma bifana vegan. Tu...",
    answers: [
      ...
      { id: "a6", text: "Não interessa o que come, interessa é se paga impostos.", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a8", text: "Espero que seja fiscalizado de forma eficiente.", value: "PSD" },
    ],
  },
  {
    id: 7,
    ...
    answers: [
      ...
      { id: "a8", text: "Regulação sim, mas com bom senso jurídico.", value: "PSD" },
    ],
  },
  {
    id: 8,
    ...
    answers: [
      ...
      { id: "a6", text: "O nome podia ser mais tecnocrático... mas vá.", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a6", text: "Influencer? Então que seja auditado como qualquer outro.", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a5", text: "Desde que não seja azul PSD, está tudo bem.", value: "BE" },
      { id: "a6", text: "Mais um gasto ridículo. Vistam o que quiserem.", value: "IL" },
      { id: "a7", text: "Temos de analisar o custo-benefício da medida.", value: "PSD" },
      { id: "a8", text: "A farda deve promover o espírito republicano.", value: "PS" },
    ],
  },
  {
    id: 11,
    text: "O Parlamento lança canal Twitch com lives dos debates. Tu...",
    answers: [
      ...
      { id: "a3", text: "Streaming? Usem para explicar leis com gráficos animados!", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a6", text: "Uma carteira. Responsabilidade orçamental.", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a6", text: "Onde está o estudo de impacto orçamental?", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a6", text: "Precisamos de casas acessíveis, não utopias.", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a6", text: "Mais um delírio. Precisamos é de produtividade.", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a6", text: "Quem aprovou isto e quanto custou?", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a6", text: "Espero que tenham seguro e regimento interno.", value: "PSD" },
  ...
  {
    id: 18,
    text: "A ASAE vai fiscalizar quem diz “bacalhau à Brás” quando usa pescada. Tu...",
    answers: [
      ...
      { id: "a4", text: "Pescada à Brás é traição nacional. Cadeia com eles.", value: "Chega" },
      { id: "a5", text: "Desde que seja sustentável e de origem ética, tudo bem.", value: "PAN" },
      { id: "a6", text: "O nome é importante, mas o importante é a segurança alimentar.", value: "PSD" },
  ...
  {
    id: 19,
    text: "É proposta uma lei para obrigar influencers a fazer serviço cívico antes de vender colagénio.",
    answers: [
      ...
      { id: "a6", text: "Regulação sim, mas sem censura.", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a6", text: "Tem de haver registo legal e backup físico.", value: "PSD" },
  ...
  {
    id: 21,
    text: "Um novo hino é proposto com beat trap e letra escrita por inteligência artificial.",
    answers: [
      ...
      { id: "a6", text: "Quem pagou ao produtor?", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      { id: "a1", text: "Um verdadeiro exemplo de empreendedorismo reversível.", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a8", text: "Podia ter declarado no IRS o valor do GPS.", value: "PSD" },
    ],
  },
  {
    id: 24,
    text: "O Chega diz que o candidato pedófilo e o outro que roubou malas são “casos isolados”. Reação?",
    answers: [
      { id: "a1", text: "Isolados como quem está num iglu em Agosto.", value: "BE" },
      { id: "a2", text: "Nada como limpar a casa com panos sujos.", value: "PSD" },
      { id: "a3", text: "O sistema permitiu isto. Urge mudar o sistema.", value: "PCP" },
      { id: "a4", text: "Casos isolados... com GPS, escolta e gravador de chamadas.", value: "PS" },
      { id: "a5", text: "Mais um reality show da extrema-direita. Falta o confessionário.", value: "Livre" },
      { id: "a6", text: "Que fique claro: pedófilos não têm lugar em lado nenhum!", value: "PAN" },
      { id: "a7", text: "Isto é sinal que todos os partidos deviam fazer rastreio psicológico!", value: "IL" },
      { id: "a8", text: "Esses casos deviam ser julgados — não abafados.", value: "Chega" },
    ],
  },
  {
    id: 25,
    text: "Diogo Batáguas lança mais um “Relatório DB” a expor a política portuguesa. Tu...",
    answers: [
      ...
      { id: "a6", text: "Críticas sim, mas também precisa ouvir os dois lados.", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a3", text: "Gritar não é solução. Um bom gráfico fala por si.", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a6", text: "Desde que siga as regras legais e tenha contas auditadas.", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a6", text: "Pode ser, desde que respeite os direitos de autor.", value: "PSD" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: "a6", text: "Mais oportunidades cá dentro. É urgente.", value: "PSD" },
